import {
    NavigationLink
} from '../app/shared/interfaces/navigation-link';
        ...
        menu: {
            ...
            items: [{
                    ...
                    items: [{
                        ...
                        {
                            label: 'Soldering Dryers',
                            url: '/shop/catalog'
                        },
                        {
                            label: 'Gas Soldering Iron',
                            url: '/shop/catalog'
                        },
                        {
                            label: 'Electric Soldering Iron',
                            url: '/shop/catalog'
                        }
                    ]
                },
